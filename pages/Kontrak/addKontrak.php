...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <form method="POST" action="<?= $base_url ?>backend/Kontrak/add.php">
                    <div class="subcard-grid">
                        ...
                        <div class="sub-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12"><label>Alamat</label>
                                    <textarea name="alamat" class="form-control" placeholder="Masukkan Alamat"></textarea>
                                </div>

                                <div><label>No HP</label>
                                    <input type="text" name="nomor_hp" class="form-control" placeholder="Masukkan No HP">
                                </div>
                        ...
                        <div class="sub-card">
                            ...
                            <div class="row">
                                ...
                                <div><label>TMT Kepegawaian</label>
