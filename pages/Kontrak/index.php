...
<style>
  ...
  .thead-simple-active .table-hover tbody tr:hover {
    transform: none;
  }
</style>
...
<div class="content-wrapper">
      ...
      <div class="jenis-header">
        <div class="jenis-title-wrap">
          ...
          <div>
            ...
            <span>Kelola data pegawai kontrak secara lengkap</span>
          </div>
        </div>

      </div>
      <div class="action-buttons-modern">
        <a href="addKontrak.php" class="btn-modern primary">
          <i class="fas fa-plus"></i>
          <span>Tambah</span>
        </a>
        <a href="https://docs.google.com/spreadsheets/d/1exAYQ4Aw0J0tPYciiqDzsjKfm5T_rWRQ1qqgKvJaNi0/edit?gid=118993328#gid=118993328"
  ...
  <section class="content">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-hover align-middle text-sm">
              ...
              <?php
              $query = "SELECT * FROM pegawai_kontrak";
    ...
    <?= json_encode(htmlspecialchars($row["nama"], ENT_QUOTES, "UTF-8")); ?>
                          ...
                          <a href="editKontrak.php?id=<?= $row['id']; ?>"
                            class="action-btn edit"
                            title="Edit">
                            <i class="fas fa-edit"></i>
                          </a>
                          <a href="../../backend/Kontrak/delete.php?id=<?= $row['id']; ?>"
