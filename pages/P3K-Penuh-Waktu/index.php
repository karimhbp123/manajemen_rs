      ...
      <div class="jenis-header">
        <div class="jenis-title-wrap">
          ...
          <div>
            ...
            <span>Kelola data pegawai PPPK penuh waktu secara lengkap</span>
          </div>
        </div>

      </div>
      <div class="action-buttons-modern">
        <a href="addP3KPN.php" class="btn-modern primary">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-hover align-middle text-sm">
              ...
              <?php
              $query = "SELECT * FROM pegawai_p3k_penuh_waktu";
                    ...
                    <tr class="data-row">
                      ...
                      <td class="col-aksi text-center">
                        <div class="action-group">
                          ...
                          <a href="editP3KPN.php?id=<?= $row['id']; ?>"
                            class="action-btn edit"
                            title="Edit">
                            <i class="fas fa-edit"></i>
                          </a>

                          <a href="../../backend/P3K-Penuh-Waktu/delete.php?id=<?= $row['id']; ?>"
