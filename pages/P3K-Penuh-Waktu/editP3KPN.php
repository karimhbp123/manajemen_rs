...
$id = intval($_GET['id']);
$query = "SELECT * FROM pegawai_p3k_penuh_waktu WHERE id = $id";
...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card">
        <form method="POST" action="<?= $base_url ?>backend/P3K-Penuh-Waktu/update.php">
          ...
          <div class="subcard-grid">
            ...
            <div class="sub-card">
              ...
              <div class="row">
                ...
                <div><label>NIP</label><input type="text" name="nip" class="form-control" value="<?= $data['nip']; ?>"></div>
                <div><label>NIK</label><input type="text" name="nik" class="form-control" value="<?= $data['nik']; ?>"></div>
                <div><label>NPWP</label><input type="text" name="npwp" class="form-control" value="<?= $data['npwp']; ?>"></div>
            ...
            <div class="sub-card">
              ...
              <div class="row">
                <div><label>Tempat Lahir</label><input type="text" name="tempat_lahir" class="form-control" value="<?= $data['tempat_lahir']; ?>"></div>
                <div><label>Tanggal Lahir</label><input type="date" name="tgl_lahir" class="form-control" value="<?= $data['tgl_lahir']; ?>"></div>
            ...
            <div class="sub-card">
              ...
              <div class="row">
                <div class="col-md-12"><label>Alamat</label><textarea name="alamat_rumah" class="form-control"><?= $data['alamat_rumah']; ?></textarea></div>
                <div><label>No HP</label><input type="text" name="no_telpon" class="form-control" value="<?= $data['no_telpon']; ?>"></div>
            ...
            <div class="sub-card">
              ...
              <div class="row">
                ...
                <div><label>Tanggal Akta Nikah</label><input type="date" name="tgl_akta_nikah" class="form-control" value="<?= $data['tgl_akta_nikah']; ?>"></div>
              </div>
            </div>
            ...
            <div class="sub-card">
              ...
              <div class="row">
                ...
                <div><label>TMT CPNS</label><input type="date" name="tmt_cpns" class="form-control" value="<?= $data['tmt_cpns']; ?>"></div>
                <div><label>Jabatan</label><input type="text" name="jabatan" class="form-control" value="<?= $data['jabatan']; ?>"></div>
                <div><label>TMT Jabatan</label><input type="date" name="tmt_jabatan" class="form-control" value="<?= $data['tmt_jabatan']; ?>"></div>
                <div><label>Eselon</label><input type="text" name="eselon" class="form-control" value="<?= $data['eselon']; ?>"></div>
                <div><label>Unit Kerja</label><input type="text" name="unit" class="form-control" value="<?= $data['unit']; ?>"></div>
                <div class="col-md-12"><label>Keterangan</label><input type="text" name="keterangan_mekanisme_jabatan" class="form-control" value="<?= $data['keterangan_mekanisme_jabatan']; ?>"></div>
                <div>
            ...
            <div class="sub-card">
              ...
              <div class="row">
                ...
                <div class="col-md-12"><label>Pelatihan</label><textarea name="diklat" class="form-control"><?= $data['diklat']; ?></textarea></div>
              </div>
            </div>
            ...
            <div class="sub-card">
              ...
              <div class="row">
                <div><label>2024</label><input type="date" name="rencana_kgb_2024" class="form-control" value="<?= $data['rencana_kgb_2024']; ?>"></div>
                <div><label>2025</label><input type="date" name="rencana_kgb_2025" class="form-control" value="<?= $data['rencana_kgb_2025']; ?>"></div>
                <div><label>2026</label><input type="date" name="rencana_kgb_2026" class="form-control" value="<?= $data['rencana_kgb_2026']; ?>"></div>
              </div>
            </div>
            ...
            <div class="sub-card">
              ...
              <div class="row">
                <div><label>No STR</label><input type="text" name="str_no" class="form-control" value="<?= $data['str_no']; ?>"></div>
                <div><label>Tanggal STR</label><input type="date" name="tgl_str" class="form-control" value="<?= $data['tgl_str']; ?>"></div>
                <div><label>Masa Berlaku</label><input type="date" name="masa_berlaku" class="form-control" value="<?= $data['masa_berlaku']; ?>"></div>
                <div><label>SIP</label><input type="text" name="sip" class="form-control" value="<?= $data['sip']; ?>"></div>
              </div>
            </div>
