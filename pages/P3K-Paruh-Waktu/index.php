      ...
      <div class="jenis-header">
        <div class="jenis-title-wrap">
          ...
          <div>
            ...
            <span>Kelola data pegawai PPPK paruh waktu secara lengkap</span>
          </div>
        </div>
      </div>

      <div class="action-buttons-modern">
        <a href="addP3KPR.php" class="btn-modern primary">
          <i class="fas fa-plus"></i>
          <span>Tambah</span>
        </a>
        <a href="https://docs.google.com/spreadsheets/d/1exAYQ4Aw0J0tPYciiqDzsjKfm5T_rWRQ1qqgKvJaNi0/edit?gid=1880711722#gid=1880711722"
                    ...
                    <tr class="data-row">
                      ...
                      <td class="col-aksi text-center">
                        <div class="action-group">
                          ...
                          <a href="editP3KPR.php?id=<?= $row['id']; ?>"
                            class="action-btn edit"
                            title="Edit">
                            <i class="fas fa-edit"></i>
                          </a>
                          <a href="../../backend/P3K-Paruh-Waktu/delete.php?id=<?= $row['id']; ?>"
