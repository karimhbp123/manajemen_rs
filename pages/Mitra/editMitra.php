...
// ambil data
$query = "SELECT * FROM pegawai_mitra WHERE id = $id";
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <form method="POST" action="<?= $base_url ?>backend/Mitra/update.php">
                    ...
                    <div class="subcard-grid">
                        ...
                        <div class="sub-card">
                            ...
                            <div class="row">
                                ...
                                <div><label>No HP</label><input type="text" name="no_hp" class="form-control" value="<?= $data['no_hp']; ?>"></div>
