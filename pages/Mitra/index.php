      ...
      <div class="jenis-header">
        <div class="jenis-title-wrap">
          ...
          <div>
            ...
            <span>Kelola data pegawai Mitra secara lengkap</span>
          </div>
        </div>
      </div>
      <div class="action-buttons-modern">
        <a href="addMitra.php" class="btn-modern primary">
                ...
                <?php if ($result && $result->num_rows > 0): ?>
                  <?php while ($row = $result->fetch_assoc()): ?>
                    <tr class="data-row">
                      ...
                      <td class="col-tmt text-center"><?= date('d-m-Y', strtotime($row['tmt'])); ?></td>
                      <td class="col-masa">
                        <?php
                        $tmt = new DateTime($row['tmt']); // tanggal mulai kerja
                      ...
                      <td class="col-aksi text-center">
                        <div class="action-group">
                          ...
                          <a href="../../backend/Mitra/delete.php?id=<?= $row['id']; ?>"
